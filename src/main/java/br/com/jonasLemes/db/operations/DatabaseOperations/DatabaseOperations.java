package br.com.jonasLemes.db.operations.DatabaseOperations;
...
import br.com.jonasLemes.jsfTeste.controllers.SchoolBean;
import br.com.jonasLemes.jsfTeste.infra.SchoolEntityManager;
import java.util.ArrayList;

public class DatabaseOperations {

	private static final String PERSISTENCE_UNIT_NAME = "jsfCrud";	
	...
	public static List<SchoolBean> getAllSchoolDetails() {
		...
		schoolList = queryObj.getResultList();
